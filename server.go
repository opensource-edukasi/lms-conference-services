...
import (
	...
	"lms-conference-service/internal/config"
	"lms-conference-service/internal/middleware"
	"lms-conference-service/internal/pkg/db/postgres"
	"lms-conference-service/internal/pkg/db/redis"
	"lms-conference-service/internal/route"
)
